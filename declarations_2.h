...
extern void solver(vertex *, fval *, fval *, fval *, mg_grid *, pbcs&, int);

extern void explicit_solver(vertex *, fval *, fval *, fval *, mg_grid *, pbcs&);
extern void bcs(vertex *,fval *,double); 
...
extern void poisson_source(fval * , fval *, fval *, mg_grid *, double);
...
/****************************************************************************/	
//Staggered functions for the evaluation of source terms of Poisson equation

void interpol_cen_hface(fval*, fval*, int); 
void interpol_cen_vface(fval*, fval*, int); 
void derv_hface2node_x(fval*, fval*, int);  //d/dx(hface_value) on node
void derv_vface2node_y(fval*, fval*, int);  //d/dy(vface_value) on node
